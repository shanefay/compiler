...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 97; i <= 97; ++i) start[i] = 2;
		for (int i = 99; i <= 122; ++i) start[i] = 2;
		start[34] = 3; 
		start[43] = 6; 
		start[45] = 7; 
		start[91] = 8; 
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "switch": t.kind = 34; break;
			case "case": t.kind = 35; break;
			case "default": t.kind = 37; break;
			case "for": t.kind = 38; break;
			case "do": t.kind = 39; break;
